...
for b in bags:
    if b != my_bag and contains(bags, b, my_bag):
        has_my_bag += 1
print(f"goddamn the string parsing for this problem was hell: {has_my_bag}")
print(
    f"but boy i have improved on my recursion skills in a year tho: {bag_number(bags, my_bag)}"
)
